...
const PILLARS = [
  ...
  },
  {
    ...
    accent: 'one',
    tail: 'philosophy',
    body: 'Gourmet By The Woods plates fine dining under the canopy, with produce from Royalton Farms inside the estate. Pihu does rooftop romance. Berry & Beans is for morning coffee. The Den is for telescopic nights.',
    img: '/images/dining/gourmet-by-the-woods.webp',
    video: '/videos/dining-arrival.mp4',
    href: '/dining',
    meta: '04 Restaurants · Royalton Farms',
  },
  {
    eyebrow: 'Wellness',
    lead: 'Long hours at',
