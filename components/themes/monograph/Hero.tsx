...
/**
 * Monograph Hero — Editorial layout with the Modernist palette.
 * Identical structure to the Editorial hero; the primary CTA's contrast pair
 * is swapped to use --color-text-inverse so the button stays legible when both
 * --color-gold and --color-charcoal collapse to the same deep-green accent
 * under this palette.
 */
const MonographHero = () => {
    ...
    <section className="relative h-screen w-full overflow-hidden">
      <div className="absolute inset-0 bg-black">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to bottom, rgba(31, 42, 36, 0.25), rgba(31, 42, 36, 0.5))',
          }}
        />
      </div>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                ...
                className="min-w-[200px] border-white/70 text-white hover:bg-white hover:text-[var(--color-text)]"
                style={{
                  fontWeight: 500,
                  letterSpacing: '1.5px',
                  textTransform: 'uppercase',
